            ...
            <div class="tab-content active" id="tab-profile">
                <form id="editProfileForm">
                    <div class="form-group">
                        ...
                        <input type="text" id="editName" value="John Michael Teacher" placeholder="Enter your full name">
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="editPhone">Phone</label>
                            <input type="tel" id="editPhone" value="+1 (555) 987-6543" placeholder="Enter your phone">
                        </div>
                        <div class="form-group">
                            <label for="editDob">Date of Birth</label>
                            <input type="date" id="editDob" value="1985-06-20">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="editAddress" rows="2" placeholder="Enter your address">456 Faculty Drive, University Town, ST 54321</textarea>
                    </div>
                </form>
            </div>
                ...
                <form id="securityForm">
                    ...
                    <div class="security-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="currentEmail" value="john.teacher@school.edu" disabled>
                        </div>
                        <div class="form-group">
