<!-- Failed Modal -->
<div class="modal-overlay" id="failedModal">
    <div class="modal-container failed-modal">
        <div class="failed-modal-content">
            ...
            <h3 class="failed-title" id="failedTitle">Oops!</h3>
            <p class="failed-message" id="failedMessage">Something went wrong. Please try again.</p>
